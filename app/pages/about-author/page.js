              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-8">
                  ...
                  <p className="text-xl text-slate-700 leading-relaxed font-light">
                    ...
                    and relentless introspection, Joel now lives in the woods of
                    Florida.There, he continues to write, paint, reflect, and
                    share his unique voice with the world, not for fame, but for
                    the simple act of honest communication.{" "}
                  </p>
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              <blockquote className="text-2xl md:text-3xl font-serif italic leading-relaxed mb-8">
                "Every old house holds secrets, every family has stories waiting
                to be told. I simply listen to what the walls whisper."
              </blockquote>
