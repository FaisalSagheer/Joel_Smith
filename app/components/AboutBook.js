      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            {/* Enhanced Book Cover */}
            <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
              <div className="relative inline-block group">
                {/* Main book with enhanced effects */}
                <div className="relative">
                  <div className="w-80 h-96 bg-gradient-to-br from-slate-800 to-slate-900 rounded-lg shadow-2xl transform rotate-2 hover:rotate-0 transition-all duration-500 hover:scale-105 group-hover:shadow-amber-400/20 group-hover:shadow-3xl">
                    <div className="p-8 h-full flex flex-col justify-between text-white relative overflow-hidden">
                      {/* Subtle pattern overlay */}
                      <div className="absolute inset-0 bg-gradient-to-br from-transparent via-amber-400/5 to-transparent"></div>
                      
                      <div className="relative z-10">
                        <h3 className="text-2xl font-serif mb-4 animate-fade-in">Some Observations and Opinions</h3>
                        <div className="w-16 h-px bg-amber-400 mx-auto mb-4 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
                      </div>
                      <div className="text-center relative z-10">
                        <p className="text-lg font-serif mb-2">Joel Aaron Smith</p>
                        <p className="text-sm text-slate-300">A Observation</p>
                      </div>
                    </div>
                  </div>
            ...
            <div className={`space-y-6 transition-all duration-1200 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
              <div className="relative">
                <h2 className="text-4xl font-serif text-slate-800 mb-6 animate-fade-in delay-400">About the Book</h2>
       ...
       With his feet planted firmly on the deck of his self-built home in the rural Florida woods, <em className="text-amber-700 font-medium">Joel Aaron Smith</em> reflects on everything from the nature of God to the state of modern America, from abstract painting to the personalities of cats and dogs.
              </p>
              ...
              <Card className="bg-white shadow-lg border-l-4 border-amber-400 animate-fade-in delay-1000 hover:shadow-xl hover:scale-105 transition-all duration-300 transform">
                <CardContent className="p-6 relative">
                  ...
                  <cite className="block mt-3 text-sm text-slate-500 font-medium">— Publishers Weekly</cite>
                </CardContent>
              </Card>
